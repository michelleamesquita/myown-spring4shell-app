...
public class HandlingFormSubmissionApplicationTest {
	...
	public void submitsForm() throws Exception {
		mockMvc.perform(post("/greeting").param("id", "39.7").param("content", "Hello"))
//				.andExpect(content().string(containsString("Temperature: 39.7")))
				.andExpect(content().string(containsString("Fahrenheit: 103.46001")));
	}
